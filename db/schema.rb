...
ActiveRecord::Schema[7.0].define(version: 2022_05_01_023452) do
  ...
  create_table "line_foods", force: :cascade do |t|
    ...
    t.integer "restraurant_id", null: false
    t.integer "order_id"
    ...
    t.index ["restraurant_id"], name: "index_line_foods_on_restraurant_id"
  end
  ...
  add_foreign_key "line_foods", "restraurants"
end
